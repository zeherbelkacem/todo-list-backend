package com.belkacem.todolistbackend.exceptions;
...
public class TodoExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleTodoAlreadyExists(EntityAlreadyExistsException ex, WebRequest request){
